...
(function () {
    ...
    (function () {
        ...
        $m.add(".calendar_default_cell_inner", "position: absolute;top: 0px;left: 0px;bottom: 0px;right: 0px;border-right: 1px solid #ddd;border-bottom: 1px solid #ddd; background: #7e7e7e;");
    ...
    DayPilot.Locale.US = DayPilot.Locale.find("fr-fr");
...
(function () {
    ...
    DayPilotCalendar.Calendar = function (id) {
        ...
        this.api = 2;
        this.borderColor = "#e58306";
        this.businessBeginsHour = 7;
        this.businessEndsHour = 20;
        this.cellHeight = 35;
        ...
        this.$2q = function () {
            ...
            this.nav.top.style.width = this.width ? this.width : '99%';
...
(function () {
    ...
    DayPilotMonth.Month = function ($b) {
        ...
        this.drawCell = function (x, y, $0e) {
            var $p = this.rows[y];
            var d = this.firstDate.addDays(y * 8 + x);
